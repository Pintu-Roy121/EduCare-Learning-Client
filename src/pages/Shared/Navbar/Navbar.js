...
const Navbar = () => {
    ...
    // console.log(user);
    return (
        <div className='w-full bg-gray-200 shadow-lg sticky top-0 z-50'>
            <nav className="relative w-11/12 mx-auto flex flex-wrap items-center justify-between py-3 focus:text-gray-700 ">
                <div className="container-fluid w-full flex items-center justify-between px-6">
                    <div className="container-fluid">
                        <Link to='/'> <img className='w-14 md:w-20' src={logo} alt="" /></Link>
                    </div>
                    <div className='flex gap-3 md:gap-4 lg:gap-5 items-center text-sm md:text-base font-semibold'>
                        ...
                        <div onClick={handleToggle} >
                            {
                                toggle ?
                                    <p className='flex font-semibold items-center'>Light<TiAdjustBrightness className='text-4xl' /></p>
                                    :
                                    <p className='flex font-bold items-center'>Dark<TiAdjustContrast className='text-4xl' /></p>
                            }
                        </div>
                    </div>
                </div>
