...
const Header = () => {
    return (
        <div className="hero h-[700px]" style={{ backgroundImage: `url("https://venturebeat.com/wp-content/uploads/2021/05/GettyImages-1291886933-e1624308433688.jpg?fit=2309%2C1154&strip=all")` }}>
